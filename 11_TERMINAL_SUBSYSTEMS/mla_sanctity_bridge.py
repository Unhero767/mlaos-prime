...
def main():
    ...
    file_path = os.path.join(core_dir, "ash_sanctity.gd")
    with open(file_path, "w") as f:
        f.write(SANCTITY_CONTENT)
    
    print(f"[SANCTITY] Successfully injected hash chain watcher -> {file_path}")
